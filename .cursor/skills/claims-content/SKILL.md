...
description: >-
  ...
  Use when editing or adding content under reality-protocols, human-condition, or
...
**Thoughts subsections (`###`):** Use **plain titles** with **no leading emoji**. The template already adds icons for the main bands (**Claim**, **Thoughts**, **Grounding**, **Dig deeper**); emoji on every body subsection tends to look busy. Subsections still appear in **Contents** nested under **Thoughts**.
...
- Examples: `content/reality-protocols/2026-04-01-memes/index.md` (coinage + quote exhibit), `content/reality-protocols/2026-04-03-shared-reality/index.md` (theory + PDF source), `content/human-condition/2026-04-10-empathy-levels/index.md` (developmental moral empathy + layered tags).
